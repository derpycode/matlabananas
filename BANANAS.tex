...
Open up a new \textsf{Figure window}. You can define a set of axes anywhere in the window you like via the \texttt{axes} function:
\begin{docspec}
axes('pos',[x,y,dx,dy])
\end{docspec}
...
\end{docspec}
You then specify what (\textit{x,y}) limits the axes represented, e.g.:
\begin{docspec}
